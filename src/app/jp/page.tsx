...
import { CommandMenu } from "@/components/command-menu-jp";
  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-8">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        ...
        <Section>
          <h2 className="text-xl font-bold">概 要</h2>
          <p className="text-pretty font-mono text-sm text-muted-foreground">
            {RESUME_DATA.summary}
          </p>
        </Section>
        <Section>
          <h2 className="text-xl font-bold">職 歴</h2>
        ...
        <Section>
          <h2 className="text-xl font-bold">学 歴</h2>
        ...
        <Section>
          <h2 className="text-xl font-bold">技 能</h2>
        ...
        <Section className="print-force-new-page scroll-mb-16">
          <h2 className="text-xl font-bold">事 業</h2>
